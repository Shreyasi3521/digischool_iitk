...
class ALL_FORUMS(models.Model):
	...
	forum_question = models.JSONField() # json format {"question" : "question content", "upvote counter"}
	...
	forum_answers = models.JSONField() # json format {"answer1": "answer content", "date_answer": "datetime string" , "user" : "loginapp.USER_SIGNUPUP_DATABASE.id", "upvotecounter": value (negative means more downvotes)}