...
class ALL_FORUMS(models.Model):
	...
	forum_answers = models.TextField() #{"1" : jsonfilepath, 2: . .. # json format {"answer1": "answer content", "date_answer": "datetime string" , "user" : "loginapp.USER_SIGNUPUP_DATABASE.id", "upvotecounter": value (negative means more downvotes)}