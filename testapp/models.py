...
class ALL_TESTS(models.Model):
	...
	files = models.CharField(max_length=FILES_STRING_MAX_LENGTH) # an array represented as string, where, each element is file path
	test_unique_id = models.CharField(max_length=LECTURE_UNIQUE_ID) # "course_id(10):test_series_number(2)"
