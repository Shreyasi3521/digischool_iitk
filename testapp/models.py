...
class ALL_TESTS(models.Model):
	...
	test_questions = models.TextField(default=None) # contains file path
	test_data = models.TextField(default=None) # # contains scores. json format {"maximumscore": 100, "minimumscore":0 , loginapp.USER_SIGNUPUP_DATABASE.id": "score", . .  . .. . }
